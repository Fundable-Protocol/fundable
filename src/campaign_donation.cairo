...
pub mod CampaignDonation {
    ...
    impl CampaignDonationImpl of ICampaignDonation<ContractState> {
        ...
        fn get_donation(self: @ContractState, campaign_id: u256, donation_id: u256) -> Donations {
            ...
            // Return empty donation if not found - FIXED: Using try_into instead of deprecated
            // const
            Donations {
                donation_id: 0, donor: 0_felt252.try_into().unwrap(), campaign_id: 0, amount: 0,
            }
        }
    ...
    impl InternalImpl of InternalTrait {
        fn get_asset_address(self: @ContractState, token_name: felt252) -> ContractAddress {
            ...
            if token_name == 'USDC' || token_name == 'usdc' {
                token_address =
                    0x053c91253bc9682c04929ca02ed00b3e423f6710d2ee7e0d5ebb06f3ecf368a8_felt252
                    .try_into()
                    .unwrap();
            }
            ...
            if token_name == 'ETH' || token_name == 'eth' {
                token_address =
                    0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7_felt252
                    .try_into()
                    .unwrap();
            }
            if token_name == 'USDT' || token_name == 'usdt' {
                token_address =
                    0x068f5c6a61780768455de69077e07e89787839bf8166decfbf92b645209c0fb8_felt252
                    .try_into()
                    .unwrap();
            }
        ...
        fn _process_internal_donation(
            ...
            let (_donation_id, _actual_amount) = self
                ._process_internal_donation_with_return(donor, campaign_id, amount);
        }
